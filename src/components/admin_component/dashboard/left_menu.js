				...
				<li>
					...
					<ul className="sub-menu">
						<li>
							...
							<span className="badge badge-warning">new</span>Right Sidebar Page</a>
						</li>
						<li>
				...
				<li>
					...
					<ul className="sub-menu">
						...
						<li>
							...
							<span className="badge badge-danger">new</span>Font Icons</a>
						</li>
						<li>
						...
						<li>
							<a href="ui_tree.html">
							<span className="badge badge-danger">new</span>Tree View</a>
						</li>
						<li>
							<a href="ui_page_progress_style_1.html">
							<span className="badge badge-warning">new</span>Page Progress Bar - Style 1</a>
						</li>
						<li>
						...
						<li>
							...
							<span className="badge badge-danger">new</span>Alerts &amp; Dialogs API</a>
						</li>
						<li>
						...
						<li>
							...
							<span className="badge badge-success">new</span>Date Paginator</a>
						</li>
						<li>
				...
				<li>
					...
					<ul className="sub-menu">
						...
						<li>
							...
							<span className="badge badge-warning">new</span>Form X-editable</a>
						</li>
						<li>
						...
						<li>
							...
							<span className="badge badge-danger">new</span>Image Cropping</a>
						</li>
						<li>
				...
				<li>
					...
					<ul className="sub-menu">
						...
						<li>
							...
							<span className="badge badge-danger">new</span>New Portlets #1</a>
						</li>
						<li>
							<a href="portlet_general3.html">
							<span className="badge badge-danger">new</span>New Portlets #2</a>
						</li>
						<li>
				...
				<li>
					...
					<ul className="sub-menu">
						...
						<li>
							...
							<span className="badge badge-danger">4</span>Todo</a>
						</li>
						<li>
							<a href="inbox.html">
						...
						<li>
							...
							<span className="badge badge-info">4</span>Timeline</a>
						</li>
						<li>
						...
						<li>
							...
							<ul className="sub-menu">
								<li>
									...
									<ul className="sub-menu">
										<li>
											<a href="#"><i className="icon-power"></i> Sample Link 1</a>
										</li>
										<li>
											<a href="#"><i className="icon-paper-plane"></i> Sample Link 1</a>
										</li>
										<li>
											<a href="#"><i className="icon-star"></i> Sample Link 1</a>
										</li>
									</ul>
								</li>
								<li>
									<a href="#"><i className="icon-camera"></i> Sample Link 1</a>
								</li>
								<li>
									<a href="#"><i className="icon-link"></i> Sample Link 2</a>
								</li>
								<li>
									<a href="#"><i className="icon-pointer"></i> Sample Link 3</a>
								</li>
							</ul>
						</li>
						<li>
							...
							<ul className="sub-menu">
								<li>
									<a href="#"><i className="icon-tag"></i> Sample Link 1</a>
								</li>
								<li>
									<a href="#"><i className="icon-pencil"></i> Sample Link 1</a>
								</li>
								<li>
									<a href="#"><i className="icon-graph"></i> Sample Link 1</a>
								</li>
							</ul>
						</li>
						<li>
