...
function RenderSubMenu(props){
  return(
    <ul className="dropdown-menu agile_short_dropdown">
      <li><a href="https://p.w3layouts.com/demos_new/template_demo/20-06-2017/elite_shoppy-demo_Free/143933984/web/icons.html">Web Icons</a></li>
      <li><a href="https://p.w3layouts.com/demos_new/template_demo/20-06-2017/elite_shoppy-demo_Free/143933984/web/typography.html">Typography</a></li>
    </ul>
  );
}
  ...
  render(){
    ...
    <div className="header" id="home">
    	<div className="container">
    		<ul>
    		    <li> <a href="https://p.w3layouts.com/demos_new/template_demo/20-06-2017/elite_shoppy-demo_Free/143933984/web/index.html#" data-toggle="modal" data-target="#myModal"><i className="fa fa-unlock-alt" aria-hidden="true"></i> Sign In </a></li>
    			<li> <a href="https://p.w3layouts.com/demos_new/template_demo/20-06-2017/elite_shoppy-demo_Free/143933984/web/index.html#" data-toggle="modal" data-target="#myModal2"><i className="fa fa-pencil-square-o" aria-hidden="true"></i> Sign Up </a></li>
    ...
    <div className="header-bot">
    	<div className="header-bot_inner_wthreeinfo_header_mid">
    		<div className="col-md-4 header-middle">
    			<form action="https://p.w3layouts.com/demos_new/template_demo/20-06-2017/elite_shoppy-demo_Free/143933984/web/index.html#" method="post">
    			...
    			<div className="col-md-4 logo_agile">
    				<h1><a href="https://p.w3layouts.com/demos_new/template_demo/20-06-2017/elite_shoppy-demo_Free/143933984/web/index.html"><span>E</span>lite Shoppy <i className="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1>
    			</div>
    		<div className="col-md-4 agileits-social top_content">
    						<ul className="social-nav model-3d-0 footer-social w3_agile_social">
    						                                   <li className="share">Share On : </li>
    															<li><a href="https://p.w3layouts.com/demos_new/template_demo/20-06-2017/elite_shoppy-demo_Free/143933984/web/index.html#" className="facebook">
    															...
    															<li><a href="https://p.w3layouts.com/demos_new/template_demo/20-06-2017/elite_shoppy-demo_Free/143933984/web/index.html#" className="twitter">
    															...
    															<li><a href="https://p.w3layouts.com/demos_new/template_demo/20-06-2017/elite_shoppy-demo_Free/143933984/web/index.html#" className="instagram">
    															...
    															<li><a href="https://p.w3layouts.com/demos_new/template_demo/20-06-2017/elite_shoppy-demo_Free/143933984/web/index.html#" className="pinterest">
    	...
    	<div className="container">
    		...
    		<div className="top_nav_right">
    			<div className="wthreecartaits wthreecartaits2 cart cart box_1">
    						<form action="https://p.w3layouts.com/demos_new/template_demo/20-06-2017/elite_shoppy-demo_Free/143933984/web/index.html#" method="post" className="last">
    					...
    					<div className="modal-header">
    						...
    						<h3 className="agileinfo_sign">Sign In <span>Now</span></h3>
    						  ...
    						  <ul className="social-nav model-3d-0 footer-social w3_agile_social top_agile_third">
    														...
    														<div className="clearfix"></div>
    														<p><a href="https://p.w3layouts.com/demos_new/template_demo/20-06-2017/elite_shoppy-demo_Free/143933984/web/index.html#" data-toggle="modal" data-target="#myModal2"> Don/t have an account?</a></p>
    						...
    						<h3 className="agileinfo_sign">Sign Up <span>Now</span></h3>
    						 <form action="https://p.w3layouts.com/demos_new/template_demo/20-06-2017/elite_shoppy-demo_Free/143933984/web/index.html#" method="post">
    						  ...
    						  <ul className="social-nav model-3d-0 footer-social w3_agile_social top_agile_third">
    														...
    														<div className="clearfix"></div>
    														<p><a href="https://p.w3layouts.com/demos_new/template_demo/20-06-2017/elite_shoppy-demo_Free/143933984/web/index.html#">By clicking register, I agree to your terms</a></p>
